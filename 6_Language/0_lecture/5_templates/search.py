...
# The input to the AI is a corpus of documents and an abstracted example like "Facebook, 2004".
# The AI will generate Templates by looking at how the example occurs in the documents, e.g.
# "{Facebook} was founded in {2004}".
# That can be used to extract new information that matches these Templates.
