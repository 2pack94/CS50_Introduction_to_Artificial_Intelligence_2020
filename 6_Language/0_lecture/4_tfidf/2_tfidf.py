...
# Use Inverse Document Frequency (IDF) together with TF.
# IDF is a measure of how rare a word is across documents in a corpus.
# IDF = log(total_documents / num_documents_containing(word))
# TF and IDF are multiplied to apply a higher weight to words that are common
# in one document but that appear in few other documents.
